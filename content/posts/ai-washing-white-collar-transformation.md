---
title: "AI Washing and the White-Collar Transformation: What History Teaches Us"
date: 2026-02-28T18:40:00+09:00
draft: false
...
| Google | "AI investment" | Margin compression, search disruption |
| Meta | "Year of Efficiency" | Metaverse bet failed, needed pivot |
| Twitter | "Hardcore" culture | Overstaffed pre-Musk, unsustainable burn |
...
1. **Drop out** (some did)
2. **Become a machine operator** (many did)
3. **Move to higher-value tasks** (design, quality control, sales)
...
What's happening:
1. Executives are using AI as cover for restructuring
2. Companies are experimenting with AI-augmented operating models
3. Competition is intensifying for white-collar workers
4. New job categories are emerging
5. The transition is compressed vs. historical parallels

**The real question:** Can society absorb the transition fast enough?

**Industrial Revolution:** 70 years
**AI Revolution:** 7-10 years?
